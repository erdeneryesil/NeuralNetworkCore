...
Descriptions of the files in the <a href="https://github.com/erdeneryesil/NeuralNetworkCore/tree/master/NeuralNetworkTerminal/sample">sample</a> directory are below.<br /><br />
