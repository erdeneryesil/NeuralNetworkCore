...
private:
    ...
    //Run variables
    QString _runInputInfo;
    QString _runOutputInfo;
    QString _runInfo;
...
private slots:
    ...
    void slotAddLineForNNDiagram(qreal,qreal,qreal, qreal,QPen);
    void slotAddEllipseForNNDiagram(qreal,qreal,qreal, qreal,QPen,QBrush);
